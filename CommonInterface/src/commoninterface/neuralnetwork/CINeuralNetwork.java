...
public abstract class CINeuralNetwork implements Serializable {
	...
	public void setWeights(double[] weights) {
		if (weights.length != genomeLength) {
			throw new IllegalArgumentException("Found " + weights.length + " weights, but need " + genomeLength
					+ " for " + this.getClass() + " with " + numberOfInputNeurons + " input neurons and "
					+ numberOfOutputNeurons + " output neurons.\nNNInputs: " + inputs + "\nOutputs: " + outputs);
		}
	...
	public static CINeuralNetwork getNeuralNetwork(RobotCI robot, CIArguments arguments) {
		...
		CINeuralNetwork network = (CINeuralNetwork) CIFactory.getInstance(arguments.getArgumentAsString("classname"),
