...
public class EnemyCISensor extends ConeTypeCISensor {
	private static final long serialVersionUID = -5860637559590070560L;
	...
	protected void sensedEntity(Entity e) {
		...
		if (share && e instanceof RobotLocation) {
			...
			if (rl.getDroneType() == AquaticDroneCI.DroneType.ENEMY) {
				SharedDroneLocation dl = new SharedDroneLocation(rl.getName(), robot.getNetworkAddress(),
						rl.getLatLon(), rl.getDroneType());
