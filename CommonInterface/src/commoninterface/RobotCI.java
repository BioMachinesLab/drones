...
public interface RobotCI {
	 ...
	 * 
	 * @return get the time elapsed since the controller was started (in
	 *         seconds).
	 */
	public double getTimeSinceStart();

	/**
	 * Get the list of entities that have been detected/received by the drone
	 * (waypoints, other drones' locations, etc).
	 * 
	...
	/**
	 * The BroadcastHandler takes care of communication with nearby drone. It is
	 * possible to send and receive messages.
	 * 
	...
	/**
	 * Resets the status of the robot, for instance, stops the wheels, turns off
	 * any active behavior.
	 */
	public void reset();

	/**
	 * Gets the list of MessageProviders. The MessageProviders are responsible
	 * for replying to information requests.
	 * 
