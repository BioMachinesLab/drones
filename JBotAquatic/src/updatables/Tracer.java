...
public abstract class Tracer implements Stoppable {
    ...
    protected Color robotColor = Color.RED;
    ...
    protected SVGGraphics2D createCanvas(Simulator sim) {
    ...
    protected void writeGraphics(SVGGraphics2D gr, Simulator sim, String filePrefix) {
        if (drawGeofence) {
            drawGeofence(gr, sim);
        }
