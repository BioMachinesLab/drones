...
public class TestHierarchicalMissionEnvironment extends BoundaryEnvironment {
	private static final long serialVersionUID = -3475656597419583910L;
	...
	public void setup(Simulator simulator) {
		...
		this.setup = true;
		if (!simple) {
			AquaticDrone enemy = new AquaticDrone(simulator,
					new Arguments("diameter=2,gpserror=1.8,commrange=40,rudder=0"));
	...
	private void createFence(Simulator simulator) {
		...
		commoninterface.mathutils.Vector2d vec = CoordinateUtilities
				.GPSToCartesian(new LatLon(38.766524638824215, -9.094010382164727));
